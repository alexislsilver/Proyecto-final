...
import 'package:pruebafirebase/pages/logear.dart';
import 'package:pruebafirebase/pages/opeFirebase.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Alexis Covarrubias',
      theme: ThemeData(
        ...
        child: FutureBuilder<List<User>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                print('Error al conectarse intente de nuevo');
              }
              return Center(
